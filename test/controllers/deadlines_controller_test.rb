...
class DeadlinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deadline" do
    assert_difference('Deadline.count') do
      post deadlines_url, params: { deadline: { category: @deadline.category, completed_at: @deadline.completed_at, date: @deadline.date, label: @deadline.label, project_id: @deadline.project_id, user_id: @deadline.user_id } }
    end
  ...
  test "should update deadline" do
    patch deadline_url(@deadline), params: { deadline: { category: @deadline.category, completed_at: @deadline.completed_at, date: @deadline.date, label: @deadline.label, project_id: @deadline.project_id, user_id: @deadline.user_id } }
