document.addEventListener("turbolinks:load", function () {
  ...
  var triggerContainer = document.querySelector("#js-project-editbox");

  if (triggerContainer) {
    var starIcon = buildStarIcon();
  ...
  var activeProjectId = window.location.pathname.split("/").pop();
  var trigger = document.querySelector("#js-favourite");
  var favourites = document.querySelector("#js-favourites-list");
  ...
  function projectIsAlreadyInFavourites(projectId) {
    if (localStorage.getItem("favourites") !== null) {
      var currentFavourites = JSON.parse(localStorage.getItem("favourites"));
  ...
  function removeProjectFromFavourites(project) {
    ...
    var newFavourites = currentFavourites.filter(function(e) { return e.id !== project.id; })
  ...
  if (favourites) {
    ...
    var voidImg = favourites.children[0];
  ...
  function buildStarIcon() {
    ...
    var starIconWrapper = document.createElementNS("http://www.w3.org/2000/svg", "svg");
